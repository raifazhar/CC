...
Mul:                                              ; preds = %loop
  %new_result3 = fmul float %current_result, %truncated
...
define i32 @main() {
entry:
  %result = call float (i32, i32, ...) @arthimatic(i32 3, i32 2, double 3.000000e+00, double 2.000000e+00, double 7.000000e+00)
